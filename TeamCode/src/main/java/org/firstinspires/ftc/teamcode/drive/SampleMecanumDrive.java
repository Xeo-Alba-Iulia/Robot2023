...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(7.6, 0, 1);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(8.2, 0, 0.7);

    public static double LATERAL_MULTIPLIER = 1.9094102961;
